...
import com.goo.vapps.bluetooth.chat.Activities.MainActivity;
...
public class ChatService {
	...
	public static boolean devicenotfound=false;
...
//		System.out.println("Connected");
		...
		bundle.putString(MainActivity.DEVICE_ADDRESS1, device.getAddress());
		msg.setData(bundle);
	...
	private void connectionFailed() {
		...
		Bundle bundle = new Bundle();
		bundle.putString(MainActivity.TOAST, "Device not available!");
		msg.setData(bundle);
		handler.sendMessage(msg);
		devicenotfound=true;
	...
	private void connectionLost() {
		Message msg = handler.obtainMessage(MainActivity.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putString(MainActivity.TOAST, "Chat Disconnected!");
		msg.setData(bundle);
		handler.sendMessage(msg);
...
//						public void run() {
//								MainActivity.customAdapter1.notifyDataSetChanged();
//
//
//						}
//					});
